...
function ManageInventory() {
    ...
    const SearchProduct = async () => {
        try {
            const response = await axios.get('http://localhost:5000/mainstocks/showStock');
    ...
    const handleInsert = async () => {
        try {
            ...
            const response = await axios.post('http://localhost:5000/mainstocks/addStock', {
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await axios.put(`http://localhost:5000/mainstocks/updateProduct/${defaultId}`, {
    ...
    const handleDelete = async () => {
        ...
        try {
            window.confirm("Are you Sure?");
            const response = await axios.delete(`http://localhost:5000/mainstocks/deleteProduct/${defaultId}`);
