...
function ManageManuInventory() {
    ...
    const SearchProduct = async () => {
        try {
            const response = await axios.get('http://localhost:5000/manu_stocks/showStock');
            ...
            if (isAvailable) {
                ...
                setUpdateProductQuantity(availableProduct.produced_quantity);
    ...
    const handleInsert = async () => {
        try {
            ...
            const response = await axios.post('http://localhost:5000/manu_stocks/addStock', {
                product_id: iproductId,
                product_name: iproductName,
                produced_quantity: iproductQuantity,
            });
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await axios.put(`http://localhost:5000/manu_stocks/updateStock/${defaultId}`, {
                product_id: uproductId,
                product_name: uproductName,
                produced_quantity: uproductQuantity,
            });
    ...
    const handleDelete = async () => {
        ...
        try {
            window.confirm("Are you Sure?");
            const response = await axios.delete(`http://localhost:5000/manu_stocks/deletetock/${defaultId}`);
                            ...
                            <table className="fl-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{fetchedProduct.produced_quantity}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
export default ManageManuInventory;
